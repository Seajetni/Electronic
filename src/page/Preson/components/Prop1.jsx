...
Command: npx gltfjsx@6.2.3 public/models/Prop/prop1.glb
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function Porp1 (props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('models/Prop/prop1.glb')
...
useGLTF.preload('models/Prop/prop1.glb')
