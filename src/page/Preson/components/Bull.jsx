...
Command: npx gltfjsx@6.2.3 public/models/Prop/Bull.glb
*/
...
export function Bull (props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('models/Prop/Bull.glb')
...
useGLTF.preload('models/Prop/Bull.glb')
